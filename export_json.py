    ...
    for r in results:
        ...
        game = {
            ...
            "ml": {
                ...
                "away_best": od.get("away_ml_best"),
                "away_best_book": od.get("away_ml_book"),
                "home_best": od.get("home_ml_best"),
                "home_best_book": od.get("home_ml_book"),
            ...
            "totals": {
                ...
                "over_med": od.get("over_juice"),
                "over_best": od.get("over_best"),
                "over_best_book": od.get("over_book"),
                "under_med": od.get("under_juice"),
                "under_best": od.get("under_best"),
                "under_best_book": od.get("under_book"),
                "n_books": od.get("n_books"),
                "lean": lean,
                "lean_runs": lean_gap,
                "tier": t_tier,
            },
