...
for (r in 4:nrow(slate)) {
  ...
  slate_rows[[as.character(tab)]] <- list(
    ...
    n_books=as_num(cell(slate,r,20)),
    away_best=as_num(cell(slate,r,21)), away_best_book=cell(slate,r,22),
    home_best=as_num(cell(slate,r,23)), home_best_book=cell(slate,r,24),
    over_med=as_num(cell(slate,r,25)),  over_best=as_num(cell(slate,r,26)),
    over_best_book=cell(slate,r,27),
    under_med=as_num(cell(slate,r,28)), under_best=as_num(cell(slate,r,29)),
    under_best_book=cell(slate,r,30)
  )
}
...
for (key in names(slate_rows)) {
  ...
  games[[length(games)+1]] <- list(
    ...
    ml=list(
      ...
      away_best=s$away_best, away_best_book=s$away_best_book,
      home_best=s$home_best, home_best_book=s$home_best_book,
    ...
    totals=list(
      ...
      over_med=s$over_med, over_best=s$over_best, over_best_book=s$over_best_book,
      under_med=s$under_med, under_best=s$under_best, under_best_book=s$under_best_book,
      n_books=s$n_books,
